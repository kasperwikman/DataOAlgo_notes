...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        bikeShop.addBike(new Bike("Bianchi", 300, DiscountCategory.RETURNED));
        bikeShop.addBike(new Bike("Tunturi", 300, DiscountCategory.USED));
        ...
        for (int i = 0; i < bikeShop.getBikeCount(); i++) {
            ...
            System.out.printf("%d - %s %.2f € stock: %d st, condition: %s (orig. price: %.2f)\n",
                    i+1,
                    bike.getName(),
                    bike.getPrice(),
                    bike.getStock(),
